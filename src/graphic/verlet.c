...
//     // Create SDL window
//     SDL_Window* window = SDL_CreateWindow("ImGui SDL2 Example", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
...
//     // Setup ImGui backends for SDL and OpenGL
...
//     printf("before loop\n");
//     ImVec4 circleColor;
//     circleColor.x = 1.0f;  // Red component
//     circleColor.y = 1.0f;  // Green component
//     circleColor.z = 1.0f;  // Blue component
//     circleColor.w = 1.0f;  // Alpha component (transparency)
//     bool done = false;
//     while (!done) {
//         SDL_Event event;
//         while (SDL_PollEvent(&event)) {
...
//         igText("Welcome to ImGui with SDL2!");
//         igColorEdit4("Circle Color", (float *)&circleColor, ImGuiColorEditFlags_Float);
//         igEnd();
...
//         // Draw a triangle using SDL's OpenGL functions
//         glColor4f(circleColor.x, circleColor.y, circleColor.z, circleColor.w);
//         drawCircle(0.0f, 0.0f, 0.5f, 30);  // Change the center (0.0f, 0.0f), radius (0.5f), and number of segments as needed.
